package com.example.review.beans;
import com.example.review.restcontroller.ReviewProcessor;
...
public class SavedBeans {
    ...
    @Bean
    public MessageListenerAdapter adapter(ReviewProcessor roomCleanerProcessor) {
